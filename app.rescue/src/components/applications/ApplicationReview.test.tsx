...
vi.mock('./ApplicationReview.css', () => {
  const EXPORTS = [
    'addEventForm', 'addEventTitle', 'button', 'buttonGroup', 'card', 'cardTitle',
    'closeButton', 'completeVisitForm', 'completeVisitTitle', 'content',
    'emptyTimeline', 'emptyVisits', 'errorContainer', 'errorMessage', 'errorText',
    'field', 'fieldLabel', 'fieldValue', 'fieldValueFullWidth', 'fieldVertical',
    'formActions', 'formField', 'formGroup', 'formInput', 'formLabel', 'formRow',
    'formSelect', 'formTextarea', 'grid', 'header', 'headerContent', 'headerLeft',
    'headerRight', 'headerSubtitle', 'headerTitle', 'label', 'loadingContainer',
    'loadingText', 'modal', 'notesInput', 'overlay', 'referenceActions',
    'referenceCard', 'referenceContact', 'referenceForm', 'referenceHeader',
    'referenceInfo', 'referenceName', 'referenceNotes', 'referenceRelation',
    'referenceStatus', 'rescheduleForm', 'rescheduleTitle', 'scheduleVisitForm',
    'scheduleVisitTitle', 'section', 'sectionHeader', 'sectionTitle', 'select',
    'spinner', 'stageBadge', 'statusBadge', 'statusSelect', 'statusUpdateContainer',
    'tab', 'tabContainer', 'tabList', 'tabPanel', 'textArea', 'timelineContainer',
    'timelineContent', 'timelineData', 'timelineDescription', 'timelineHeader',
    'timelineIcon', 'timelineItem', 'timelineTimestamp', 'timelineTitle',
    'timelineUser', 'visitActions', 'visitCard', 'visitCompletedInfo', 'visitDate',
    'visitDetailsContent', 'visitDetailsHeader', 'visitDetailsModal', 'visitHeader',
    'visitInfo', 'visitNotes', 'visitOutcome', 'visitStaff', 'visitStatus', 'visitTime',
  ] as const;
