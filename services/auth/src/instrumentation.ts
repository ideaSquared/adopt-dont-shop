// OpenTelemetry SDK bootstrap for service.auth.
//
// Same --import-flag pattern as service.notifications and service.gateway:
// tsx / node loads this BEFORE the rest of the service so the auto-
