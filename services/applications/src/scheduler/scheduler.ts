// Tick-based scheduler for periodic applications jobs (ADS-1320). Each job
...
export type SchedulerOptions = {
  ...
  // Called when a job's run() throws, in addition to the error log line.
  // Optional — this service has no metrics registry of its own yet.
