...
// Note: POST /webhook/delivery is mounted directly in index.ts (before cookieParser)
// as a fully self-contained handler chain so it is never subject to CSRF middleware.
