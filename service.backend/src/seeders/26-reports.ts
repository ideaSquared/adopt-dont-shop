  ...
  try {
    ...
    const reports = [
      ...
      },
      {
        ...
        reportedEntityId: pets[0]?.pet_id || 'pet_001',
      ...
      // Under review reports
      {
        ...
        reportedEntityType: 'pet' as const,
        reportedEntityId: pets[1]?.pet_id || 'pet_002',
      ...
      },
      {
        ...
        reportedEntityType: 'pet' as const,
        reportedEntityId: pets[2]?.pet_id || 'pet_003',
        category: ReportCategory.SPAM,
    ...
    await Report.bulkCreate(reports as any);
