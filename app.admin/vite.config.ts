  ...
  const libraryAliases =
    mode === 'development'
      ? {
          ...
          '@adopt-dont-shop/lib.audit-logs': resolve(__dirname, '../lib.audit-logs/src'),
          ...
          '@adopt-dont-shop/lib.moderation': resolve(__dirname, '../lib.moderation/src'),
          ...
          '@adopt-dont-shop/lib.support-tickets': resolve(__dirname, '../lib.support-tickets/src'),
