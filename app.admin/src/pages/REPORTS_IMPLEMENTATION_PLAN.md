...
export class ReportService {
  static async generateReport(type: ReportType, parameters: object, userId: string): Promise<Report>
  static async getReportById(reportId: string): Promise<Report>
  static async listReports(filters: ReportFilters, pagination: Pagination): Promise<PaginatedResponse<Report>>
...
export class ReportExportService {
  ...
  static async saveExportedFile(reportId: string, format: ReportFormat, content: Buffer | string): Promise<string>
}
```
