import{i as e}from"./preload-helper-xPQekRTU.js";import{n as t,t as n}from"./ErrorState-qC-ccPJj.js";var r,i,a,o,s;e((()=>{t(),r={title:`Components/ErrorState`,component:n,tags:[`autodocs`],argTypes:{size:{control:{type:`select`},options:[`sm`,`md`,`lg`]}}},i={args:{title:`Something went wrong`,message:`We could not load this content.`}},a={args:{title:`Failed to load pets`,message:`Please check your connection and try again.`,onRetry:()=>{}}},o={args:{message:`This report is temporarily unavailable.`}},i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  args: {
