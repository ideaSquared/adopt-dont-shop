	...
	return (
		<div ref={dropdownRef} className='relative w-full'>
			...
			{isOpen && (
				<ul
					role='listbox'
					aria-activedescendant={countryValue}
				...
				>
					{countries.map((country, index) => (
						<li
							...
							className={`w-full flex items-center px-4 py-2 text-left text-gray-700 hover:bg-gray-100 cursor-pointer ${
								country.name === countryValue ? 'bg-gray-200' : ''
