...
const PreferencesService = {
	fetchUserPreferences: async (): Promise<any> => {
		try {
	...
	addPreference: async (preference: any): Promise<any> => {
		try {
	...
	updatePreference: async (id: string, preference: any): Promise<any> => {
		try {
	...
	fetchAllPreferences: async (): Promise<any> => {
		try {
