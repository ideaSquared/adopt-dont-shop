...
import { PERMISSIONS, requireAdmin, requirePermissionOrOwnership } from '../middleware/rbac';
...
router.put('/profile', userValidation.updateProfile, UserController.updateUserProfile);
