...
const PetFormSidebar: React.FC<PetFormSidebarProps> = ({
	show,
	handleClose,
	petDetails,
	setPetDetails,
	...
	const renderSelectOptions = (category: keyof AllowedPreferencesType) => {
		return allowedPreferences[category].map((preference: string) => (
