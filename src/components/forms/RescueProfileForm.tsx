    ...
    <form onSubmit={onSubmitUpdates}>
      <div className='grid grid-cols-1 md:grid-cols-2 gap-4 mb-3'>
        <div className='space-y-2'>
          <label htmlFor='rescueName' className='block text-sm font-medium text-gray-700'>
            Rescue name
          </label>
          <input
            type='text'
        ...
        <div className='space-y-2'>
          <label htmlFor='rescueType' className='block text-sm font-medium text-gray-700'>
            Rescue type
          </label>
          <select
            id='rescueType'
            name='rescueType'
            value={rescueProfile.rescueType || 'individual'}
            onChange={handleRescueInfoChange}
            disabled={!canEditRescueInfo}
            className='mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm'
            aria-required='true'
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 gap-4 mb-3'>
        <div className='space-y-2'>
          ...
          <div className='flex items-center'>
            ...
            <button
              ...
              disabled={!canEditRescueInfo || rescueProfile.referenceNumberVerified}
        ...
        <div className='space-y-2'>
          ...
          <CountrySelect
            onCountryChange={(value: string) => handleRescueInfoChange(value)}
