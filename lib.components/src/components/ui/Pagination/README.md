...
```tsx
<Pagination currentPage={3} totalPages={10} onPageChange={page => console.log('Page:', page)} />
```

### With First/Last Buttons

```tsx
<Pagination currentPage={5} totalPages={20} onPageChange={handlePageChange} showFirstLast />
```
...
<Pagination currentPage={3} totalPages={10} onPageChange={handlePageChange} variant='default' />;

{
  /* Outlined variant */
}
<Pagination currentPage={3} totalPages={10} onPageChange={handlePageChange} variant='outlined' />;

{
  /* Minimal variant */
}
<Pagination currentPage={3} totalPages={10} onPageChange={handlePageChange} variant='minimal' />;
```
...
<Pagination currentPage={10} totalPages={20} onPageChange={handlePageChange} siblingCount={2} />;
```
