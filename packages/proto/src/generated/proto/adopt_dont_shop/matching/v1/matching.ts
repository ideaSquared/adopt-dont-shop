...
export const GetTopPicksResponse: MessageFns<GetTopPicksResponse> = {
  ...
  fromJSON(object: any): GetTopPicksResponse {
    return { picks: globalThis.Array.isArray(object?.picks) ? object.picks.map((e: any) => TopPick.fromJSON(e)) : [] };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<GetTopPicksResponse>, I>>(object: I): GetTopPicksResponse {
    const message = createBaseGetTopPicksResponse();
...
export const MatchingServiceService = {
  ...
  getTopPicks: {
    ...
    requestStream: false as const,
    responseStream: false as const,
    requestSerialize: (value: GetTopPicksRequest): Buffer => Buffer.from(GetTopPicksRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): GetTopPicksRequest => GetTopPicksRequest.decode(value),
    responseSerialize: (value: GetTopPicksResponse): Buffer => Buffer.from(GetTopPicksResponse.encode(value).finish()),
