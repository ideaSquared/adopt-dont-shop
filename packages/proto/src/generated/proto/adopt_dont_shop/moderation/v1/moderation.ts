...
export const AssignSupportTicketRequest: MessageFns<AssignSupportTicketRequest> = {
  ...
  create<I extends Exact<DeepPartial<AssignSupportTicketRequest>, I>>(
    base?: I
  ): AssignSupportTicketRequest {
    return AssignSupportTicketRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<AssignSupportTicketRequest>, I>>(
    object: I
  ): AssignSupportTicketRequest {
    const message = createBaseAssignSupportTicketRequest();
    message.ticketId = object.ticketId ?? '';
...
export const AssignSupportTicketResponse: MessageFns<AssignSupportTicketResponse> = {
  ...
  create<I extends Exact<DeepPartial<AssignSupportTicketResponse>, I>>(
    base?: I
  ): AssignSupportTicketResponse {
    return AssignSupportTicketResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<AssignSupportTicketResponse>, I>>(
    object: I
  ): AssignSupportTicketResponse {
    const message = createBaseAssignSupportTicketResponse();
    message.ticket =
...
export const ModerationServiceService = {
  ...
  assignSupportTicket: {
    ...
    requestDeserialize: (value: Buffer): AssignSupportTicketRequest =>
      AssignSupportTicketRequest.decode(value),
    responseSerialize: (value: AssignSupportTicketResponse): Buffer =>
      Buffer.from(AssignSupportTicketResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): AssignSupportTicketResponse =>
      AssignSupportTicketResponse.decode(value),
  },
} as const;
