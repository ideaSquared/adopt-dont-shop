...
export const AcknowledgeSanctionRequest: MessageFns<AcknowledgeSanctionRequest> = {
  encode(message: AcknowledgeSanctionRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.sanctionId !== "") {
      writer.uint32(10).string(message.sanctionId);
    }
    return writer;
  ...
  create<I extends Exact<DeepPartial<AcknowledgeSanctionRequest>, I>>(base?: I): AcknowledgeSanctionRequest {
    return AcknowledgeSanctionRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<AcknowledgeSanctionRequest>, I>>(object: I): AcknowledgeSanctionRequest {
    const message = createBaseAcknowledgeSanctionRequest();
    message.sanctionId = object.sanctionId ?? "";
    return message;
  },
...
export const AcknowledgeSanctionResponse: MessageFns<AcknowledgeSanctionResponse> = {
  encode(message: AcknowledgeSanctionResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.sanction !== undefined) {
      UserSanction.encode(message.sanction, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  create<I extends Exact<DeepPartial<AcknowledgeSanctionResponse>, I>>(base?: I): AcknowledgeSanctionResponse {
    return AcknowledgeSanctionResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<AcknowledgeSanctionResponse>, I>>(object: I): AcknowledgeSanctionResponse {
    const message = createBaseAcknowledgeSanctionResponse();
    message.sanction = (object.sanction !== undefined && object.sanction !== null)
      ? UserSanction.fromPartial(object.sanction)
      : undefined;
...
function createBaseAssignSupportTicketRequest(): AssignSupportTicketRequest {
  return { ticketId: "", assignedTo: "" };
}

export const AssignSupportTicketRequest: MessageFns<AssignSupportTicketRequest> = {
  encode(message: AssignSupportTicketRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.ticketId !== "") {
      writer.uint32(10).string(message.ticketId);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AssignSupportTicketRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseAssignSupportTicketRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): AssignSupportTicketRequest {
    return {
      ticketId: isSet(object.ticketId)
        ? globalThis.String(object.ticketId)
        : isSet(object.ticket_id)
  ...
  toJSON(message: AssignSupportTicketRequest): unknown {
    const obj: any = {};
    if (message.ticketId !== "") {
      obj.ticketId = message.ticketId;
    }
  ...
  create<I extends Exact<DeepPartial<AssignSupportTicketRequest>, I>>(base?: I): AssignSupportTicketRequest {
    return AssignSupportTicketRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<AssignSupportTicketRequest>, I>>(object: I): AssignSupportTicketRequest {
    const message = createBaseAssignSupportTicketRequest();
    message.ticketId = object.ticketId ?? "";
...
function createBaseAssignSupportTicketResponse(): AssignSupportTicketResponse {
  return { ticket: undefined };
}

export const AssignSupportTicketResponse: MessageFns<AssignSupportTicketResponse> = {
  encode(message: AssignSupportTicketResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.ticket !== undefined) {
      SupportTicket.encode(message.ticket, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AssignSupportTicketResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseAssignSupportTicketResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): AssignSupportTicketResponse {
    return { ticket: isSet(object.ticket) ? SupportTicket.fromJSON(object.ticket) : undefined };
  },

  toJSON(message: AssignSupportTicketResponse): unknown {
    const obj: any = {};
    if (message.ticket !== undefined) {
      obj.ticket = SupportTicket.toJSON(message.ticket);
    }
  ...
  create<I extends Exact<DeepPartial<AssignSupportTicketResponse>, I>>(base?: I): AssignSupportTicketResponse {
    return AssignSupportTicketResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<AssignSupportTicketResponse>, I>>(object: I): AssignSupportTicketResponse {
    const message = createBaseAssignSupportTicketResponse();
    message.ticket = (object.ticket !== undefined && object.ticket !== null)
      ? SupportTicket.fromPartial(object.ticket)
      : undefined;
...
export const ModerationServiceService = {
  ...
  acknowledgeSanction: {
    ...
    requestDeserialize: (value: Buffer): AcknowledgeSanctionRequest => AcknowledgeSanctionRequest.decode(value),
    responseSerialize: (value: AcknowledgeSanctionResponse): Buffer =>
      Buffer.from(AcknowledgeSanctionResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): AcknowledgeSanctionResponse => AcknowledgeSanctionResponse.decode(value),
  },
  /**
   ...
   */
  assignSupportTicket: {
    path: "/adopt_dont_shop.moderation.v1.ModerationService/AssignSupportTicket" as const,
    requestStream: false as const,
    responseStream: false as const,
    requestSerialize: (value: AssignSupportTicketRequest): Buffer =>
      Buffer.from(AssignSupportTicketRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): AssignSupportTicketRequest => AssignSupportTicketRequest.decode(value),
    responseSerialize: (value: AssignSupportTicketResponse): Buffer =>
