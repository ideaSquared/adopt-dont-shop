...
```tsx
<RadioInput name='validation' options={options} error='Please select an option' required />
```

### Horizontal Layout

```tsx
<RadioInput name='layout' options={options} direction='horizontal' label='Select preference' />
```
