...
| [scheduler](./scheduler/README.md)                 | Tick-based periodic-job scheduler with an optional cross-instance claim, so a multi-replica service runs each job exactly once per interval.                                                                                                 |
